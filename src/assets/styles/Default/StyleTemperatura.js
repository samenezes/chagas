...
const StyleTemperatura = {
    ...
    TextoTemperatura : styled.h6 `
        font-family: Poppins, 'sans-serif';
        font-size: 14px;
        font-weight: 400;
    `,

    TextoTemperaturaExcluida : styled.h6 `
        font-family: Poppins, 'sans-serif';
        font-size: 14px;
        font-weight: 400;
    ...
    BtnTemperaturaExcluida : styled.button `
        border-radius: 30px;
    ...
    BtnExcluirTemperatura : styled.button `
        border-radius: 30px;
...
export default StyleTemperatura